    ...
    ui(new Ui::authentication)
{
    ...
    QString dbAddress = "192.168.1.103";
...
if(db.open() == false){
 ...
 //db.driver()->subscribeToNotification("new_quote_added");
// QObject::connect(db.driver(),SIGNAL(Notify(const QString&)), this, SLOT(testDBListener(const QString&)));
