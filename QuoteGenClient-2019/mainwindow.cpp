...
void MainWindow::accept(){
    ...
    q.custom1 = ui->carriageCustom1LineEdit->text();
    q.custom2 = ui->carriageCustom2LineEdit->text();


    //custom
    q.customPrice1 = ui->customPrice1SpinBox->text().toInt();
    q.customPrice2 = ui->customPrice2SpinBox->text().toInt();
    q.customPrice1 = ui->carriageCustomPrice1SpinBox->text().toInt();
    q.customPrice2 = ui->carriageCustomPrice2SpinBox->text().toInt();
...
void MainWindow::loadDefaults(){
    ...
    i++;
    connectionsTo[i] = "carriageCustom1";
    connectionsFrom[i] = "carriageCustom1LineEdit";
    i++;
    connectionsTo[i] = "carriageCustom2";
    connectionsFrom[i] = "carriageCustom2LineEdit";
    i++;
